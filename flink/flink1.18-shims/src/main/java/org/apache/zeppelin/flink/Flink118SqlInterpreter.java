...
public class Flink118SqlInterpreter {

  private static final Logger LOGGER = LoggerFactory.getLogger(Flink118SqlInterpreter.class);
  ...
  public Flink118SqlInterpreter(FlinkSqlContext flinkSqlContext, boolean isBatch) {
